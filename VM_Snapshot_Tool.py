...
# Author: Seenu Perumal
# Contact: seenu.perumal@dell.com
# Date: 2023-08-27
# Description: This script performs various VMware Snapshot operations.  Feel free to use it and share if you have any feedback.
...
from Snapshot_Operation.Take_Snapshot import take_snap
...
def show_menu():
    print('''  This script will help to performs various VMware Snapshot operations.  Feel free to use and share your feedback.
